        ...
        { cartItems?.length === 0 ? (
            ...
            <div className="row d-flex justify-content-between">
                    ...
                    <div className="cart-item" data-key="product1">
                        <div className="row">
                            ...
                            <div className="col-4 col-lg-1 mt-4 mt-lg-0">
                                <i onClick={()=>removeCartItemHandler(item?.product)} id="delete_cart_item" className="fa fa-trash btn btn-danger"></i>
                            </div>
                        </div>
                    </div>
                    <hr />
                ...
                <div className="col-12 col-lg-3 my-4">
                    ...
                    <hr />
                    <button onClick={checkoutHandler} id="checkout_btn" className="btn btn-primary w-100">
                        Check Out
                    </button>
                </div>
            </div>
